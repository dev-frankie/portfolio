...
React와 Next.js를 활용하여 확장성이 뛰어난 애플리케이션을 설계·구현하였으며, SSR과 SSG를 통해 성능 최적화 및 SEO 개선을 달성했습니다.

상태관리: Redux, Recoil, RTK-Query 등을 이용하여 복잡한 UI 환경에서 전역 상태를 효과적으로 동기화하고 유지관리하는 강력한 상태 관리 시스템을 구축했습니다.

테스트: Playwright를 사용한 E2E 테스트와 Vittest를 통한 단위 테스트를 도입하여, 코드의 안정성

빌드 및 성능 최적화:
Vite 를 사용하여 번들 크기를 최소화하고, 전반적인 애플리케이션 성능을 극대화했습니다

CI/CD: Github ci/cd를 이용해
