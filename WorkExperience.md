...
> - ffmpeg을 활용하여 썸네일 추출
> - 슬라이더를 이용해 구간설정
> - Ffmpeg을 통하여 비디오 트림을 진행하고, 비디오 트림시 이전 상태를 Redux에 저장하여, 사용자가 언제든지 변경 사항을 되돌릴 수 있도록 복구 기능 제공
> - 비디오 컨트롤 기능
...
>
> - 반응형 UI 적용
>   - useResizeObserver를 활용해 화면 크기 변화를 실시간 감지
>   - 툴바 크기가 일정 수준 이하로 작아지면 Floating 모드로 자동 변환
>   - 브라우저 상대 좌표를 기반으로 적절한 위치에 툴바 배치
>   - 효율적인 렌더링 최적화
> - 에셋별 지원 기능을 DB에서 관리하여 일관된 데이터 구조 유지
>   - 선택된 에셋에 맞춰 필요한 기능만 동적으로 렌더링하여 성능 최적화
...
>   - AWS SES(Simple Email Service) 연동을 통해 합성 완료 메일 발송.
> - 각종 신규유저, 기존 유저대상으로 여러 가지 데모 퍼널을 만들어 A/B테스트 진행
>   - GA 태그 설정 및 사용자 속성 관리
> - Amplitude SDK를 적용하여 track, setUserProperties를 활용한 행동 데이터 세분화
>   - Baidu Analytics를 통한 사용자 구매/전환 이벤트 설정
> - 드립 마케팅 이메일 캠페인 진행
...
> - 유저 설문조사 기반 대시보드 개선
>   - 회원가입시 설문조사 진행
>   - 대시보드 페이지 내 배너 및 템플릿 최적화하여 사용자 경험 개선
...
#### 2.3.3 **_농협 태블릿 AI 실시간 통역 서비스 설계 및 개발_**
...
> **요구 사항**
>
> - 정부과제로 대규모 학습용 얼굴 데이터 10만여장 이상 필요
...
> <img src="./assets/image_search.jpg" width="250"/> <img src="./assets/img_reco.jpg" width="240"/> > <img src="./assets/img_reco2.jpg" width="270"/>
